...
const portfolioDetails = {
  ...
  projects: {
    ...
    cnc: {
      ...
      summary:
        "실제 제조 현장의 CNC/MCT 및 PLC 데이터를 분석해 공구 교체, 제품 풀량 위험을 예측하고,\n웹 대시보드와 3D·VR 사용자 경험까지 연결한 통합 프로젝트입니다.",
    ...
    "customs-db": {
      ...
      title:
        "수출입 통관 업무 DB 구축 및 UNI-PASS API 연동",

      summary:
        "관세사무소의 실제 수출입 통관 업무 흐름을 분석하고, 반복적으로 발생하는 업체·신고·거래 정보를\n"+
        "체계적으로 관리할 수 있도록 관계형 데이터베이스를 설계·구축했습니다. 또한 관세청 UNI-PASS 및 외부 조회 데이터를 연동하여\n"+
        "통관·환율·물류 관련 정보를 업무 시스템에서 조회하고 활용할 수 있도록 구현했습니다.",


      links: [

        {
          label: "관세사무소 수출입통관 DB 자료",
          type: "CANVA",
...

        {
          label: "올데이 관세사무소",
          type: "WEB",
          url: "https://xn--zb0b25jp6g83f8talpf1y9sc.kr/"
        }
      ...
      sections: [

        {
          ...
          html: `
            <p>
              관세사무소의 실제 수출입 통관 업무 흐름을 분석하고, 
              반복적으로 발생하는 업체·신고·거래 정보를 체계적으로 관리할 수 있도록 
              관계형 데이터베이스를 설계·구축했습니다. 또한 관세청 UNI-PASS 및 
              외부 조회 데이터를 연동하여 통관·환율·물류 관련 정보를 
              업무 시스템에서 조회하고 활용할 수 있도록 구현했습니다.
            </p>
          `
        },
...

        {
          ...
          html: `
            <ul>
              ...
              <li>구매자 및 거래처</li>
              <li>목적국 · 원산지</li>
              <li>HS Code 및 거래품명</li>
              <li>수출입 신고정보</li>
              <li>B/L 및 화물정보</li>
              <li>관세·부가세 및 납부정보</li>
              <li>신고필증 및 통관 관련 문서</li>
            </ul>
          `
        },
...

        {
          ...
          html: `
            <ul>
              <li>실제 수출입 통관 업무 요구사항 분석</li>
              <li>개념 ERD 및 관계형 스키마 설계</li>
              <li>업체·거래·신고정보 간 관계 정의</li>
              <li>데이터 중복 최소화를 위한 정규화</li>
              <li>업무 조회를 고려한 테이블 및 질의 구조 설계</li>
              <li>실제 관세사무소 업무 데이터와 시스템 연동</li>
            </ul>
          `
        },
        ...
        {
          title: "API 및 외부 데이터 연동",
          html: `
            <ul>
              <li>관세청 UNI-PASS 통관정보 연계</li>
              <li>관세청 수출입 과세환율 정보 연계</li>
              <li>화물관리번호 및 B/L 기반 통관조회 연계</li>
              <li>신고필증·납부영수증서·수입세금계산서 조회 기능 연계</li>
              <li>외부 데이터를 업무 화면에서 활용할 수 있도록 조회 구조 구현</li>
            </ul>
          `
        }
